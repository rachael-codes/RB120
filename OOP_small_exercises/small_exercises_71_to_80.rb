# RB 120 Small Exercises Debugging problems (1-10)
# Date: 03/20/21

# Question 1 - Community Library
class Library
...
# Question 3 - Wish You Were Here (question involving overriding the default `==` method)
class Person
  attr_reader :name
...
# Question 6 - Sorting Distances 
# Make the necessary changes to our code so that the various lengths can be properly sorted and 
...
# Question 9 - You've Got Mail!
# Example of accidental method overriding (overriding send + needing to change method name to send_mail)
...
# before fixing => undefined method `860 Blackbird Ln.' for #<PostalService:0x00005571b4aaebe8> (NoMethodError)

#-----------------------------------------------------------------------------------------------------------------------

# Question 10 - Does it rock or not?
